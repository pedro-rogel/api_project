...
class TestStringMethods(unittest.TestCase):
    ...
    def test_012_alunos_get_id(self):
        r_lista = requests.get('http://localhost:5000/alunos/2')
    ...
    def test_014_turmas_get_id(self):
        r_lista = requests.get('http://localhost:5000/turmas/2')
        self.assertEqual(r_lista.json()['nome'],'SI')


    def test_015_alunos_put_edita(self):
        r = requests.get('http://localhost:5000/alunos/2')
        self.assertEqual(r.json()['nome'],'Fernando Barril')
        requests.put('http://localhost:5000/alunos/2', json={'nome':'Felippe Fodase'})
    ...
    def test_016_professores_put_edita(self):
        ...
        requests.put('http://localhost:5000/professores/1', json={'nome':'Gustavo Santos'})
    ...
    def test_017_turmas_put_edita(self):
        ...
        requests.put('http://localhost:5000/turmas/1', json={'nome':'ADS 2B'})
